...
with engine.connect() as connection:
    ...
    test_df = pd.read_sql_query("""SELECT * FROM ASMT a INNER JOIN LEGDAT l ON a.parid = l.parid AND a.cur = l.cur AND l.taxyr = a.taxyr 
                    WHERE a.taxyr = 2025 AND l.cur = 'Y' AND a.parid = '7501-ROCHONAV'  """, engine)
    print(test_df)