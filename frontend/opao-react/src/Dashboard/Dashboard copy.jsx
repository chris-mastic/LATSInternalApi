...
{/* <!-- Sidebar/menu --> */}
<nav className="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding            side-menu" id="mySidebar"><br/>
  <a href="" onClick={w3_close} className="w3-button w3-hide-large w3-display-topleft" style={{width:'100%',fontSize:22}}>Close Menu</a>
...
<header className="w3-container w3-top w3-hide-large w3-red w3-xlarge w3-padding">
  <a href="" className="w3-button w3-red w3-margin-right" onClick={()=>{alert('ham1')}}>☰</a>
...
{/* <!-- !PAGE CONTENT! --> */}
<div className="w3-main                                     main-content" >
  ...
  <div className="w3-container" style={{marginTop:80}} id="showcase">
    ...
    <hr style={{width:50, border:5, borderStyle:'solid' ,color: 'red'}} className="w3-round"/>
  </div>
  
  {/* <!-- Photo grid (modal) --> */}
  <div className="w3-row-padding">
    <div className="w3-half">
      <img src="/w3images/kitchenconcrete.jpg" style={{width:'100%'}} onClick={()=>{alert()}} alt="Concrete meets bricks"/>
      <img src="/w3images/livingroom.jpg" style={{width:'100%'}} onClick={()=>{alert()}} alt="Light, white and tight scandinavian design"/>
      <img src="/w3images/diningroom.jpg" style={{width:'100%'}} onClick={()=>{alert()}} alt="White walls with designer chairs"/>
    </div>

    <div className="w3-half">
      <img src="/w3images/atrium.jpg" style={{width:'100%'}} onClick={()=>{alert()}} alt="Windows for the atrium"/>
      <img src="/w3images/bedroom.jpg" style={{width:'100%'}} onClick={()=>{alert()}} alt="Bedroom and office in one space"/>
      <img src="/w3images/livingroom2.jpg" style={{width:'100%'}} onClick={()=>{alert()}} alt="Scandinavian design"/>
    </div>
  </div>

  {/* <!-- Modal for full size images on click-->                     THIS COULD BE ERROR ONCLICK DISPLAY == NONE */}
  {/* <div id="modal01" className="w3-modal w3-black" style={{paddingTop:0}} onClick={{display:'none'}}>  */}
  <div id="modal01" className="w3-modal w3-black" style={{paddingTop:0, display:'none'}} > 
  ...
  <div className="w3-container" id="services" style={{marginTop:75}}>
    ...
    <hr  className="w3-round                                    width:50px;border:5px solid red side-bar-option"/>
  ...
  <div className="w3-container" id="designers" style={{marginTop:75}}>
    ...
    <hr  className="w3-round  side-bar-option"/>
